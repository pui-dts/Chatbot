    ...
    public class EnglishDialog : IDialog<string>
    {
        ...
        private async Task OnRateSelect(IDialogContext context, IAwaitable<IMessageActivity> result)
        {
            ...
            switch (selectedCard.Text) {
                case "1" : await context.PostAsync($" { this.user.ImageRate1Url1 }"); break;
                case "2" : await context.PostAsync($" { this.user.ImageRate1Url2 }"); break;
                case "3" : await context.PostAsync($" { this.user.ImageRate1Url3 }"); break;
                case "4" : await context.PostAsync($" { this.user.ImageRate1Url4 }"); break;
                case "5" : await context.PostAsync($" { this.user.ImageRate1Url5 }"); break;
